package com.mrc.departmentservice.model;
...
public class Department {
	 ...
	 * Department(long id, String departmentName, String departmentDescription,
	 * String departmentCode) { super(); this.id = id; this.departmentName =
	 * departmentName; this.departmentDescription = departmentDescription;
	 * this.departmentCode = departmentCode; } public Department() { super(); //
